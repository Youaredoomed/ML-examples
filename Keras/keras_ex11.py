...
'''
LSTM(메모리 셀의 개수, input_dim: 속성의 개수, input_length : 시퀀스 데이터의 입력 길이, return_sequences : 시퀀스 출력 여부, stateful : 상태 유지 여부)
“input_shape = (4, 1)"과 “input_dim = 1, input_length = 4”는 동일
'''
# 3. 모델 구성하기
model = Sequential()
...
for epoch_idx in range(num_epochs):
    ...
    model.reset_states() #가중치 초기화 -> 이전 데이터와 연관성이 없을때
